...
-   :fontawesome-brands-snapchat:{ .lg .middle } &nbsp; __Snapchat Ads__
    ...
    [:octicons-arrow-right-24: Setup](#snapchat-ads-integration)
...
2. On the multi-user page, click "Add access" and grant access to @Analytics_2S with `Account Administrator` permissions (or invite analytics@secondstage.io).
